...
/** FzwallpaperPlugin */
public class FzwallpaperPlugin implements MethodCallHandler {
    ...
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "fzwallpaper");
        channel.setMethodCallHandler(new FzwallpaperPlugin(registrar.activity(), channel));
    }

    private FzwallpaperPlugin(Activity activity, MethodChannel channel) {
